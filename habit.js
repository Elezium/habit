...
//shared responsibility of view and habit
  ...
  function assignEventListeners() {
    ...
    assignFormListener(form, ul);
    assignListListener(ul);
  }

  function assignFormListener(form, ul) {
...
//           render();
  ...
  function assignListListener(ul) {
